...
//         // assemble_statement(statement.kind, );
//     }
...
// fn assemble_statement(statement_kind: &StatementKind, mut pc: Address) -> Result<Vec<u16>, AssemblyError> {
//     if let Err(noore) = pc.increment(get_statement_size(statement_kind) as i32) && (noore.attempted_num > u16::max_value() as i32 + 1 || []){
//         if  {
